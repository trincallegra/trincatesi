...
Come precedentemente detto, nella pratica clinica eseguire procedure diagnostiche, terapeutiche e radiologiche a pazienti pediatrici può risultare una sfida impegnativa, dovuta alla scarsa collaborazione e comprensione degli eventi. Pertanto, al fine di ottenere i migliori risultati e prevenire nel bambino il ricordo di un'esperienza spiacevole e talora traumatica, vengono in aiuto sia l'utilizzo di farmaci sedativi ed analgesici, sia l'intervento non farmacologico. 
...
La dexmedetomidina è un farmaco relativamente recente \footnote{\`E stata approvata nel 2008 dalla Food and Drug Administration per l'utilizzo al di fuori della terapia intensiva \cite{Simeupsedazione, Uptodatepharmacology}.}, che esercita un'attività sedativa molto simile al sonno fisiologico; inoltre ha proprietà ansiolitica, moderatamente analgesica, simpaticolitica ed incide con effetti minimi sul centro del respiro \cite{Mahmoud2015}.
