...
\begin{itemize}
    ...
    \item Fase 2 (da B a C): è identificata da una linea ascendente che ritrae il passaggio della CO\ped{2} dagli alveoli alle vie aeree superiori e quindi l'espirazione di gas alveolari misti a quelli dello spazio morto, consegue un rapido incremento della concentrazione di CO\ped{2} espirata.
