...
% Color or XColor required for background colors...
...
%% \Qrating and \Qlist.
\fboxsep=1mm \fboxrule=0.1mm
\newcommand{\QO}{\fcolorbox{black}{xkcdCloudyBlue!10}{\color{xkcdCloudyBlue!10}$\ocircle$}}% or: $\ocircle$
%\newcommand{\QO}{\colorbox{xkcdCloudyBlue!10}{\color{xkcdCloudyBlue!10}$\ocircle$}}% or: $\ocircle$
