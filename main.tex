...
\usepackage[top=2cm,bottom=3cm,left=3cm,right=3cm]{geometry} % Managing custom margins
...
\PassOptionsToPackage{
        natbib=true,
        square=true, % ? -> it was already in the template
...
\renewcommand{\appendixname}{Appendici} % FONT FAMILY!
