...
%% ••• GLOBAL BASIC LAYOUT •••••••••••••••••••••••••••••••••••••••••••••••••••
\documentclass[a4,dottedtoc,twoside]{scrbook}
\usepackage[top=3cm,bottom=3cm,left=3.5cm,right=2.5cm]{geometry} % Custom margins
...
\hypersetup
{
	...
	citecolor=blumicrosoft,     % color of links to bibliography
    filecolor=blumicrosoft,     % color of file links
	 urlcolor=blumicrosoft      % color of external links
}
%% •••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••
...
%>FRONTESPIZIO
\newgeometry{top=0cm,bottom=1cm,left=3.5cm,right=2.5cm}
\input{titlepage}
\frontmatter
\restoregeometry
