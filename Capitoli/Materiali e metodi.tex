...
\begin{survey}[Questionario sulla sedazione per infermieri/e]{xkcdLightGreyBlue}
...
\newpage
       ...
       propofol (\texttt{EV}): \hfill \Qrating{11} 
    
       ketamina (\texttt{EV}, \texttt{IM}): \hfill \Qrating{11}
    
        dexmedetomidina (\texttt{EV}, \texttt{IM}, \texttt{IN}): \hfill \Qrating{11}
    
        ketamina (\texttt{EV}, \texttt{IM}): \hfill \Qrating{11}
    
        midazolam (\texttt{EV}, \texttt{IN}, \texttt{OS}): \hfill \Qrating{11}
       ...
       \Query In termini di sicurezza, quanto ti senti sicuro durante la sedazione con i seguenti farmaci (\emph{0: per niente, 1: poco, 3: molto})?
           ...
           propofol (\texttt{EV}): \hfill \Qrating{3}
           
           ketamina (\texttt{EV}, \texttt{IM}): \hfill \Qrating{3}
           
           dexmedetomidina (\texttt{EV}, \texttt{IM}, \texttt{IN}): \hfill \Qrating{3}
           
           midazolam (\texttt{EV}, \texttt{IN}, \texttt{OS}): \hfill \Qrating{3}
