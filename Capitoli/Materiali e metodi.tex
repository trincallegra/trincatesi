...
\begin{tcolorbox}[breakable,title=Questionario sulla sedazione per infermieri/e,colback=xkcdCloudyBlue!40,colframe=xkcdCloudyBlue!40,coltitle=black,colbacktitle=xkcdCloudyBlue!75,fonttitle=\sffamily\mdseries\scshape,halign title=flush center, arc=3mm, boxrule=0pt]

\begin{enumerate}
           \item Quanti anni di esperienza hai nel campo delle sedazioni peri-procedurali in età pediatrica? \Qlines{1}
           
           \item In che reparto lavori? \Qlines{1}
...
\begin{comment} % WORKS, BUT WEIRD INDENTATION
    \bgroup
        \def\arraystretch{1.5} 
          % No table here! Is a floating element!
            \begin{tabular}{ll}
...
\end{comment}
               ...
               propofol (\texttt{EV}): \colorbox{xkcdCloudyBlue!10}{0} \colorbox{xkcdCloudyBlue!10}{1} \colorbox{xkcdCloudyBlue!10}{2} \colorbox{xkcdCloudyBlue!10}{3} \colorbox{xkcdCloudyBlue!10}{4} \colorbox{xkcdCloudyBlue!10}{5} \colorbox{xkcdCloudyBlue!10}{6} \colorbox{xkcdCloudyBlue!10}{7} \colorbox{xkcdCloudyBlue!10}{8} \colorbox{xkcdCloudyBlue!10}{9} \colorbox{xkcdCloudyBlue!10}{10}
               
               ketamina (\texttt{EV}, \texttt{IM}): \colorbox{xkcdCloudyBlue!10}{0} \colorbox{xkcdCloudyBlue!10}{1} \colorbox{xkcdCloudyBlue!10}{2} \colorbox{xkcdCloudyBlue!10}{3} \colorbox{xkcdCloudyBlue!10}{4} \colorbox{xkcdCloudyBlue!10}{5} \colorbox{xkcdCloudyBlue!10}{6} \colorbox{xkcdCloudyBlue!10}{7} \colorbox{xkcdCloudyBlue!10}{8} \colorbox{xkcdCloudyBlue!10}{9} \colorbox{xkcdCloudyBlue!10}{10}
               
               dexmedetomidina (\texttt{EV}, \texttt{IM}, \texttt{IN}): \colorbox{xkcdCloudyBlue!10}{0} \colorbox{xkcdCloudyBlue!10}{1} \colorbox{xkcdCloudyBlue!10}{2} \colorbox{xkcdCloudyBlue!10}{3} \colorbox{xkcdCloudyBlue!10}{4} \colorbox{xkcdCloudyBlue!10}{5} \colorbox{xkcdCloudyBlue!10}{6} \colorbox{xkcdCloudyBlue!10}{7} \colorbox{xkcdCloudyBlue!10}{8} \colorbox{xkcdCloudyBlue!10}{9} \colorbox{xkcdCloudyBlue!10}{10}
               
               midazolam (\texttt{EV}, \texttt{IN}, \texttt{OS}): \colorbox{xkcdCloudyBlue!10}{0} \colorbox{xkcdCloudyBlue!10}{1} \colorbox{xkcdCloudyBlue!10}{2} \colorbox{xkcdCloudyBlue!10}{3} \colorbox{xkcdCloudyBlue!10}{4} \colorbox{xkcdCloudyBlue!10}{5} \colorbox{xkcdCloudyBlue!10}{6} \colorbox{xkcdCloudyBlue!10}{7} \colorbox{xkcdCloudyBlue!10}{8} \colorbox{xkcdCloudyBlue!10}{9} \colorbox{xkcdCloudyBlue!10}{10}
           ...
           \item Quanto i seguenti effetti collaterali riducono la tua soddisfazione in merito alla sedazione peri procedurale? (\emph{1: per niente, 2: poco, 3: abbastanza, 4: molto}). Più di una risposta è possibile. 
               ...
               sonnolenza:     \colorbox{xkcdCloudyBlue!10}{1} \colorbox{xkcdCloudyBlue!10}{2} \colorbox{xkcdCloudyBlue!10}{3} \colorbox{xkcdCloudyBlue!10}{4}
               
               irritabilità:   \colorbox{xkcdCloudyBlue!10}{1} \colorbox{xkcdCloudyBlue!10}{2} \colorbox{xkcdCloudyBlue!10}{3} \colorbox{xkcdCloudyBlue!10}{4}
               
               iperattività/irrequietezza: \colorbox{xkcdCloudyBlue!10}{1} \colorbox{xkcdCloudyBlue!10}{2} \colorbox{xkcdCloudyBlue!10}{3} \colorbox{xkcdCloudyBlue!10}{4}
               
               allucinazioni: \colorbox{xkcdCloudyBlue!10}{1} \colorbox{xkcdCloudyBlue!10}{2} \colorbox{xkcdCloudyBlue!10}{3} \colorbox{xkcdCloudyBlue!10}{4}
               
               incoordinazione/impaccio motorio: \colorbox{xkcdCloudyBlue!10}{1} \colorbox{xkcdCloudyBlue!10}{2} \colorbox{xkcdCloudyBlue!10}{3} \colorbox{xkcdCloudyBlue!10}{4}
               
               cefalea: \colorbox{xkcdCloudyBlue!10}{1} \colorbox{xkcdCloudyBlue!10}{2} \colorbox{xkcdCloudyBlue!10}{3} \colorbox{xkcdCloudyBlue!10}{4}
               
               vertigini: \colorbox{xkcdCloudyBlue!10}{1} \colorbox{xkcdCloudyBlue!10}{2} \colorbox{xkcdCloudyBlue!10}{3} \colorbox{xkcdCloudyBlue!10}{4}
               
               alterazioni dell’appetito: \colorbox{xkcdCloudyBlue!10}{1} \colorbox{xkcdCloudyBlue!10}{2} \colorbox{xkcdCloudyBlue!10}{3} \colorbox{xkcdCloudyBlue!10}{4}
               
               nausea/vomito: \colorbox{xkcdCloudyBlue!10}{1} \colorbox{xkcdCloudyBlue!10}{2} \colorbox{xkcdCloudyBlue!10}{3} \colorbox{xkcdCloudyBlue!10}{4}
               
               dispnea: \colorbox{xkcdCloudyBlue!10}{1} \colorbox{xkcdCloudyBlue!10}{2} \colorbox{xkcdCloudyBlue!10}{3} \colorbox{xkcdCloudyBlue!10}{4}
           ...
           \item In termini di sicurezza, quanto ti senti sicuro durante la sedazione con i seguenti farmaci (\emph{1: molto, 2: poco, 3: per niente})?
               ...
               propofol (\texttt{EV}): \colorbox{xkcdCloudyBlue!10}{1} \colorbox{xkcdCloudyBlue!10}{2} \colorbox{xkcdCloudyBlue!10}{3}
           ...
           \item Se non ti senti sicuro, specifica il perché: \Qlines{1}
...
\newpage
           ...
           \begin{Qlist}
                ...
                \item altro: \Qline{4cm}
           \end{Qlist}
           
           \item Cosa cambieresti rispetto agli standard attuali sul tipo di analgosedazione in età pediatrica nella tua Unità Operativa? \Qlines{1}
           
           \item Come vorresti che venisse sedato tuo figlio/a? \Qlines{1}
