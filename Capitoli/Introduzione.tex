...
Quest'indagine mira a valutare il grado di soddisfazione inteso dal personale infermieristico riguardo le sedazioni svolte al di fuori della sala operatoria e in merito alla qualità dei successivi risvegli, confrontando quattro agenti farmacologici tra i più comunemente utilizzati. In particolare, verranno analizzati la percezione del profilo di sicurezza dei farmaci, le preferenze relative al sito di somministrazione, la frequenza d'insorgenza di eventuali effetti avversi e il riscontro relativo alla qualità complessiva della sedazione.
Inoltre, questo lavoro di tesi si propone di confrontare i risultati di tale analisi con la letteratura nota, in particolare con lo studio precedentemente descritto, in cui l'indicatore di qualità è stato scelto nella figura del caregiver. L'obiettivo è quello di fornire delle indicazioni quanto più complete ed oggettive ai sedatori, affinché le possano applicare, laddove possibile, nella scelta farmacologica, con il fine ultimo di offrire al paziente ed alla famiglia uno standard di cura ed una qualità del servizio sanitario sempre maggiori.
